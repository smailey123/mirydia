...
// let products = [
//     new Product('https://goodbaking.pro/content/images/17/600x600l80mc0/58234470748805.webp', 'Універсал золото', 'Універсал золото форми тем.', 1),
//     new Product('https://goodbaking.pro/content/images/21/600x600l80mc0/53578125050775.webp', 'Універсал срібло', 'Універсал срібло форми тем.', 1),
//     new Product('https://goodbaking.pro/content/images/19/356x356l85nn0/57437697668877.webp', 'Стандарт', 'Стандарт форма світла', 1),
//     new Product('https://goodbaking.pro/content/images/12/356x356l85nn0/44016840330502.webp', 'Маки', 'Маки форми світла', 1),
//     new Product('https://goodbaking.pro/content/images/22/600x600l80mc0/93811826478551.webp', 'Серія 6 срібні', 'ффф', 1),
//     new Product('https://goodbaking.pro/content/images/24/600x600l80mc0/68329177088225.webp', 'Серія 6 золоті', 'gggg', 1),
//     new Product('бумажная_детская_форми_6_шт.-removebg-preview.png', 'Дитячі паперові', 'jjj', 1),
//     new Product('https://goodbaking.pro/content/images/8/600x600l80mc0/58999386098680.webp', 'Серія 9', 'mmm', 1),
//     new Product('https://goodbaking.pro/content/images/15/600x600l80mc0/29912128559714.webp', 'Серія 7', 'mmmm', 1),
//     new Product('изображение_viber_2025-03-03_14-57-11-664-removebg-preview (2).png', 'Серія 5 срібло та золото', 'nnn', 1),
//     new Product('птахи_форми_6_шт.-removebg-preview.png', 'Птахи', 'mmm', 1),
//     new Product('https://images.prom.ua/5330574649_w200_h200_bumazhnye-formy-dlya.jpg', 'Петриковка', 'mmm', 1),
//     new Product('https://varus.ua/img/product/420/420/2644009', 'Вишивка', 'mmm', 1),
//     new Product('янголи_форми_6_шт.-removebg-preview.png', 'Янголи', 'mmm', 1),
//     new Product('сказка_форми_6_шт.-removebg-preview.png', 'Казка', 'mmm', 1),
//     new Product('https://goodbaking.pro/content/images/25/600x600l80mc0/67923460640533.webp', 'Дитяча', 'mmm', 1)
// ];

function getProductCart(product, index) {
    return `<article class="item" onclick="location.href='product.html?index=${index}'">
                <div class="items-div-img"><img class="item-img" src="${product.image}"></div>
                <h2 class="items-h2">${product.title}</h2>
                <p class="item-desc">${product.description}</p>
                <p>${product.price} грн</p>
                <button class="item-buy">
...
function printProducts() {
    ...
    products.forEach((product, index) => {
        itemsContainer.innerHTML += getProductCart(product, index);
    });
}
